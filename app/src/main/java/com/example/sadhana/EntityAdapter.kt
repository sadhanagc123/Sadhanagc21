...
class EntityAdapter(private val onEntityClick: (Entity) -> Unit) :
    ...
    class EntityViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(entity: Entity) {
            ...
            itemView.findViewById<TextView>(R.id.albumTitle).text = entity.species
            itemView.findViewById<TextView>(R.id.artistName).text = entity.scientificName
            itemView.findViewById<TextView>(R.id.releaseYear).text = entity.habitat
            itemView.findViewById<TextView>(R.id.genre).text = entity.diet
            itemView.findViewById<TextView>(R.id.trackCount).text = "${entity.averageLifespan} years"
